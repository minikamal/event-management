...
if($number){
	...
	header("location:http://localhost/project/event_details1.php");
}
else
{
	header("location:http://localhost/project/participant_login.php");
}
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="get" action="event_details1.php">
