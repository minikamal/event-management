...
$qry="select * from `login` where enrollment_no='".$user."' && password='".$pass."'";
echo $qry;
...
if($number){
	...
	header("location:http://localhost/project/AfterOrganizerLogin.php");
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="get" action="AfterOrganizerLogin.php">
